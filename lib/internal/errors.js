...
class SystemError extends Error {
  constructor(key, context) {
    ...
    // Add the error code to the name.
    this.name = `SystemError [${this[kCode]}]`;
    // Access the stack to add the error code.
    this.stack;
    // Remove the direct name property again so the inherited one will be
    // visible.
    delete this.name;
  }
